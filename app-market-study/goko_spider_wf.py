...
class WatchfaceHtmlSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        price=2: priced
        '''
        url_base = 'https://goko.me/index.php?show=store_browse&id_goko=5&search=&mode=watchfaces&cat=0&price=0&orderby=&page='
    ...
    def parse_2(self, response):
        ...
        with open('html/watchfaces/' + filename, 'wb') as f:
